...
class Course2Screen extends StatefulWidget {
  ...
  const Course2Screen({Key? key, required this.channel}) : super(key: key);

  @override
  _Course2ScreenState createState() => _Course2ScreenState();
}
...
class _Course2ScreenState extends State<Course2Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Basic Conversation', style: TextStyle(fontFamily: 'Comfortaa')),
...
// The RecordButton class remains the same as in Course1Screen
